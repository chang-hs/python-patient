...
def create_app(test_config=None):
    ...
    def render_pdf_opnote(op_id):
        ...
        res = subprocess.call('/home/chang/texlive/2023/bin/x86_64-linux/platex -output-directory /home/chang/tmp /home/chang/tmp/opnote.tex', shell=True)
        res = subprocess.call('/home/chang/texlive/2023/bin/x86_64-linux/dvipdfmx -o /home/chang/tmp/opnote.pdf /home/chang/tmp/opnote', shell=True)
        cur.close()
        conn.close()
    ...
    def display_op_id_list():
        ...
        for row in results:
            op_id = row[2]
            edited_exists = file_exists(op_id, "edited")
            dicom_exists = file_exists(op_id, "dicom")
            original_exists = file_exists(op_id, "original")
